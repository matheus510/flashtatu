...
helpers.scaffolding = function(){
  ...
  var neededFolders = ['.data/', '.data/customers/', '.data/tattoos/', '.data/tokens/', '.data/users/'];
          ...
          if(!err){
            ...
            fs.mkdir(folder, function(err){
              if(!err){
                ...
                console.warn({'Error' : 'Essential folder could not be created, please restart the app'});
              }
            });
          }
        });
